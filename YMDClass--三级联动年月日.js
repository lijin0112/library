 ...
 */
/*
 骞存湀鏃ヨ仈鍔ㄤ笅鎷夐€夋嫨JS灏佽绫� Ver 1.0 鐗�
 鍒朵綔鏃堕棿:2013-3-12
 銆€鏇存柊鏃堕棿:2013-3-12
 搴旂敤璇存槑:椤甸潰鍖呭惈<script type="text/javascript" src="YMDClass.js" charset="utf-8"></script>
 ...
 new YMDselect('year1','month1','day1',1990,2,10);
 \*** 绋嬪簭鍒朵綔/鐗堟潈鎵€鏈�:Kevin QQ:251378427 E-Mail:yeminch@qq.com 缃戝潃:http://iulog.com ***/
SYT="-年-";
SMT="-月-";
SDT="-日-";
BYN=50;//骞翠唤鑼冨洿寰€鍓�50骞�
AYN=5;//骞翠唤鑼冨洿寰€鍚�0骞�
function YMDselect(){
